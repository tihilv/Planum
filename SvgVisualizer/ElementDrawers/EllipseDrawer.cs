...
internal class EllipseDrawer: ElementDrawerBase<SvgEllipse>
{
    ...
    {
        return new EllipsePrimitive(new RectangleD(new PointD(element.CenterX.Value, element.CenterY), 2.0 * element.RadiusX.Value, 2.0 * element.RadiusY.Value), ((SvgColourServer)element.Color).Colour, ((SvgColourServer)element.Fill).Colour);
    }
}